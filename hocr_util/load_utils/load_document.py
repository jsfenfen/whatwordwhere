...
def enter_page(doc, page, page_number):
    ...
    wkb = poly.hex
    this_page, created = Page.objects.get_or_create(doc=doc, page_number=page_number, defaults={'page_dimensions':poly})
...
# ignore whatever internal pagination there is, and count pages ourselves. This may cause trouble later, I dunno.
